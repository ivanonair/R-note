...
接下來，我們來在R中Demo ROC曲線與AUC值，使用現成的套件ROCR。
ROCR套件中有可用於Demo的資料集
```{r ROC curve}
#install.packages('ROCR')
#require(ROCR)
data(ROCR.simple);ROCR.simple
